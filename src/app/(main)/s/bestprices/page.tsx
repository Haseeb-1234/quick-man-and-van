...
export const metadata: Metadata = {
  title: "Best prices",
  description: "How Quick Man and Van keeps pricing fair and transparent for UK moves.",
}

export default function BestPricesPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
      <h1 className="text-3xl font-bold tracking-tight text-zinc-900">Best prices</h1>
